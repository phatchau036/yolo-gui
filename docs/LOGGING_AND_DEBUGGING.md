...
# Kiểm tra key và kết nối Drive cần body JSON, không paste secret vào chat/log công khai.
Invoke-RestMethod http://127.0.0.1:8765/api/cloud/key/check -Method Post -ContentType 'application/json' -Body '{"enabled":true,"provider":"google_drive","google_api_key":"***","root_name":"YOLO-GUI-Cloud","project_name":"Default Project"}'
```
