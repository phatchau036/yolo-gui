...
CLOUD_LOG_DIR = PROJECT_ROOT / "logs" / "cloud"
CLOUD_SETTINGS_PATH = CLOUD_LOG_DIR / "cloud-settings.local.json"
JOB_ROOT = PROJECT_ROOT / "runs" / "gui_jobs"
DEFAULT_CLOUD_DIR = PROJECT_ROOT / "runs" / "cloud"
...
def ensure_runtime_dirs() -> None:
    ...
    CLOUD_LOG_DIR.mkdir(parents=True, exist_ok=True)
    JOB_ROOT.mkdir(parents=True, exist_ok=True)
    DEFAULT_CLOUD_DIR.mkdir(parents=True, exist_ok=True)
