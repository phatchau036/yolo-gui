...
- Bật Cloud mode, nhập Google API key local, kết nối Google Drive folder và tạo mirror theo chuẩn `datasets/models/runs/annotations/configs/exports/logs/projects`.
...
Cloud Storage hiện là local mirror theo chuẩn Drive folder. Upload/sync hai chiều lên Drive private vẫn là phase OAuth/service account sau.
...
- `yolo_gui/cloud_manager.py`: lưu Cloud setting local, đọc metadata Google Drive, tạo mirror/manifest theo chuẩn thư mục chung, quản lý project Cloud Storage và snapshot job.
